...
Authors: Dave Fisher and Grant Hartman.
...
def main():
    ev3.Sound.speak('In 1884,  meridian time personnel met
    ev3.Sound.speak("    in Washington to change Earth time.
    ev3.Sound.speak('First words said was that only 1 day
    ev3.Sound.speak('could be used on Earth to not change

    ev3.Sound.speak('    the 1 day bible. So they applied the 1

    ev3.Sound.speak('day  and  ignored  the  other  3 days.

    ev3.Sound.speak('The bible time was wrong then and it

    ev3.Sound.speak('    proved wrong today. This a major lie

    ev3.Sound.speak('    has so much evil feed from it's wrong.

    ev3.Sound.speak('No man on Earth has no belly-button,

    ev3.Sound.speak('    it proves every believer on Earth a liar.

    ev3.Sound.speak('Children will be blessed for

    ev3.Sound.speak('Killing Of Educated Adults

    ev3.Sound.speak('Who Ignore 4 Simultaneous

    ev3.Sound.speak('    Days Same Earth Rotation.

    ev3.Sound.speak('Practicing  Evil  ONEness -

    ev3.Sound.speak('Upon Earth Of  Quadrants.

    ev3.Sound.speak('    Evil Adult Crime VS Youth.

    ev3.Sound.speak('    Supports Lie Of Integration.
